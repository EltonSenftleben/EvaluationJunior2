...
fun UpcomingDetailScreen(
    ...
    var movie by remember { mutableStateOf<UpcomingMovieEntity?>(null) }
    ...
    Screen(
        ...
        LoadingContent(isLoading = isLoading, modifier = Modifier.fillMaxSize()) {
            if (movie != null) {
                UpcomingDetailContent(movie, context)
...
@Composable
fun UpcomingDetailContent(movie: UpcomingMovieEntity?, context: Context, ) {
    ...
    Column(
        ...
        if (movie != null) {
            UpcomingImageLoaderDetail(movie = movie, context = context)
        }
...
@Composable
fun UpcomingImageLoaderDetail(movie: UpcomingMovieEntity, context: Context) {
